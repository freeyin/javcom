                        ...
                        <div class="am-u-sm-12 am-u-md-9">
                            <form method="post"  class="am-form am-form-horizontal">
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" name="ad_top_url" placeholder="广告链接URL">
                                    </div>
                                </div>
                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">	广告图片</label>
                                    <div class="am-u-sm-9">
                                        <input type="text" name="ad_top_pic" placeholder="广告图片">
                                    </div>
                                </div>
                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">备注</label>
                                    <div class="am-u-sm-9">
                                        <input type="text" name="ad_top_md" placeholder="如12/8~1/8广告费100元">
                                    </div>
                                </div>								
                                <div class="am-form-group">
...
if (isset($_POST['submit']) && isset($_POST['ad_top_url'])  && isset($_POST['ad_top_pic'])  && isset($_POST['ad_top_md'])) {
...
$ad_top_md = post_input($_POST["ad_top_md"]);
	...
	if ($ad_top_pic ==null) { echo'<script language="javascript">alert("广告图片不可为空"); </script>';exit();}
$ad_top_json_url=JCCMS_ROOT."ad/ad_top/ad.json";
...
alert("恭喜添加成功！"); 
window.location.href="ad_top.php" 
